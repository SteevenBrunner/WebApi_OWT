...
using WebApi_OWT.Data;
using WebApi_OWT.Models;

namespace WebApi_OWT.Controllers
{
    public class SkillsController : ApiController
    {
        private WebApi_OWTContext db = new WebApi_OWTContext();
        ...
        public async Task<IHttpActionResult> PostSkills(Skills skills)
        {
            ...
            return CreatedAtRoute("DefaultApi", new { id = skills.SkillsID }, skills);
        }
